...
<head>
  ...
  <link href="<?php echo e(asset('assets/css/preloader.css')); ?>" type="text/css" rel="stylesheet" media="screen" />

  <link href="<?php echo e(asset('modules/materialize/materialize.min.css')); ?>" type="text/css" rel="stylesheet" media="screen" />
  ...
  <!-- CORE CSS TEMPLATE - START -->
    ...
    <link href="<?php echo e(asset('assets/css/style.css')); ?>" type="text/css" rel="stylesheet" media="screen" id="main-style" />
  <!-- CORE CSS TEMPLATE - END -->

  

</head><?php /**PATH C:\xampp\htdocs\tl\resources\views/includes/header.blade.php ENDPATH**/ ?>