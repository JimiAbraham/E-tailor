...
<div class="content-area">
    ...
    <h1 class="white-text center welcome-logo index-welcome">E-Tailoring</h1>
    ...
    <div class="fullfixed index-carousel">
      ...
      <div class="carousel carousel-fullscreen carousel-slider">
          ...
          <div class="bg" style="background-image: url('assets/images/pic3.jpg')"></div>
          ...
          <div class="bg" style="background-image: url('assets/images/pic6.jpg')"></div>
          <div class="item-content center-align white-text">
          ...
          <div class="bg" style="background-image: url('assets/images/pic4.jpg')"></div>
          <div class="item-content center-align white-text">
    ...
    <div class="center index-start">
      <a href="<?php echo e(route('dashboard')); ?>" class='waves-light btn-large bg-primary'>  Get Started
      </a></div>
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tl\resources\views/index.blade.php ENDPATH**/ ?>